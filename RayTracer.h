...
/*
   ...
   a tree structure, so hierarch);al transformations have to be fully
...
void rayTrace(struct ray3D *ray, int depth, struct colourRGB *col, struct object3D *Os, double incoming_r_index, char insideFlag);	// RayTracing routine
